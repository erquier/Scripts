...
$ouPath = "OU=Users,OU=Hermosillo,OU=Contact_Centers,DC=s2g,DC=net"
...
$resultados | Export-csv -path C:\Users\la.esantana\Downloads\Scripts\Network_Restrictions\HMOOU.csv -NoTypeInformation
 
Write-Host "Reporte generado correctamente en C:\Users\la.esantana\Downloads\Scripts\Network_Restrictions"